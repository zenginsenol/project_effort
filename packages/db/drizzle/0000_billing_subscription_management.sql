...
CREATE TABLE "organizations" (
	...
	"current_plan" "subscription_plan" DEFAULT 'free' NOT NULL,
...
CREATE INDEX "idx_api_keys_user_provider" ON "api_keys" USING btree ("user_id","provider");--> statement-breakpoint
...
CREATE INDEX "idx_usage_tracking_org_month" ON "usage_tracking" USING btree ("organization_id","month_year");